...
The GPU is used for the two quantum models only; classical baselines stay on
CPU. Runtime depends on selection budgets, early stopping and available hardware.
